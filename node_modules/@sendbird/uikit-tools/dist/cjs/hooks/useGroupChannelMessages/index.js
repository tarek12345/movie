...
const useGroupChannelMessages = (sdk, channel, options = {}) => {
    ...
    const init = (0, usePreservedCallback_js_1.usePreservedCallback)((startingPoint, limit) => __awaiter(void 0, void 0, void 0, function* () {
        return new Promise((resolve) => {
            ...
            collectionInstance.setMessageCollectionHandler({
                ...
                onHugeGapDetected: () => {
                    init(Number.MAX_SAFE_INTEGER, sbuConstants_js_1.sbuConstants.collection.message.defaultLimit);
                },
            });
            collectionInstance
    ...
    const refresh = (0, usePreservedCallback_js_1.usePreservedCallback)(() => __awaiter(void 0, void 0, void 0, function* () {
        if (sdk.currentUser && channelRef.current) {
            ...
            yield init(Number.MAX_SAFE_INTEGER, sbuConstants_js_1.sbuConstants.collection.message.defaultLimit);
