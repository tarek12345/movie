...
exports.defaultMessageComparator = exports.useChannelThreadMessagesReducer = exports.arrayToMapWithGetter = void 0;
...
const defaultReducer = (_a, action) => {
    ...
    switch (action.type) {
        ...
        case 'update_new_messages': {
            ...
            if (action.value.clearBeforeAction) {
                draft['newMessageMap'] = arrayToMapWithGetter(newMessages, message_js_1.getMessageUniqId);
            }
            else {
                // Remove existing messages before update to prevent duplicate display
                const messageKeys = newMessages.map((it) => it.messageId);
                messageKeys.forEach((key) => delete draft['newMessageMap'][key]);
                draft['newMessageMap'] = Object.assign(Object.assign({}, draft['newMessageMap']), arrayToMapWithGetter(newMessages, message_js_1.getMessageUniqId));
            }
            return draft;
        }
...
const useChannelThreadMessagesReducer = (sortComparator = defaultMessageComparator) => {
    const [{ initialized, loading, refreshing, hasPreviousMessages, hasNextMessages, messageMap, newMessageMap }, dispatch,] = (0, react_1.useReducer)(defaultReducer, {
        initialized: false,
        loading: true,
        refreshing: false,
...
exports.useChannelThreadMessagesReducer = useChannelThreadMessagesReducer;
