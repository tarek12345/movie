...
import { N as NodeTypes, M as MessageInputKeys } from '../chunks/bundle-D2GzZ_yy.js';
import { a as USER_MENTION_TEMP_CHAR } from '../chunks/bundle-CpMvhj21.js';
import IconButton from './IconButton.js';
import Button, { ButtonTypes, ButtonSizes } from './Button.js';
import { r as renderToString, s as sanitizeString, n as nodeListToArray, u as usePaste, i as isChannelTypeSupportsMultipleFilesMessage, e as extractTextAndMentions } from '../chunks/bundle-GawAxqNK.js';
...
import { K, G as arrayEqual, H as getMimeTypesUIKitAccepts } from '../chunks/bundle-BA9oFJ90.js';
import { t as tokenizeMessage, T as TOKEN_TYPES, U as USER_MENTION_PREFIX } from '../chunks/bundle-AmtSwuex.js';
import { c as classnames } from '../chunks/bundle-kFa80LJe.js';
import { i as isMobileIOS } from '../chunks/bundle-DiK8ifY3.js';
import 'dompurify';
...
var scrollToCaret = function () {
    ...
    if (selection && selection.rangeCount > 0) {
        ...
        if (caretNode.nodeType === NodeTypes.TextNode) {
            var parentElement = caretNode.parentElement;
            // Scroll the parent element of the caret into view
            (_a = parentElement === null || parentElement === void 0 ? void 0 : parentElement.scrollIntoView) === null || _a === void 0 ? void 0 : _a.call(parentElement, {
                behavior: 'smooth',
                block: 'nearest',
            });
        }
...
var MessageInput = React__default.forwardRef(function (props, externalRef) {
    ...
    var handleCommonBehavior = function (handleEvent) {
        scrollToCaret();
        return function (e) { return handleEvent(e); };
    };
    return (React__default.createElement("form", { className: classnames.apply(void 0, __spreadArray(__spreadArray([], (Array.isArray(className) ? className : [className]), false), [isEdit && 'sendbird-message-input__edit',
        ...
        React__default.createElement("div", { className: classnames('sendbird-message-input', disabled && 'sendbird-message-input__disabled'), "data-testid": "sendbird-message-input" },
            ...
            React__default.createElement("div", { id: "".concat(textFieldId).concat(isEdit ? message === null || message === void 0 ? void 0 : message.messageId : ''), className: "sendbird-message-input--textarea ".concat(textFieldId), contentEditable: !disabled, role: "textbox", "aria-label": "Text Input", ref: internalRef, 
                // @ts-ignore
                disabled: disabled, maxLength: maxLength, onKeyDown: handleCommonBehavior(function (e) {
                    var _a, _b, _c, _d;
                ...
                }), onKeyUp: handleCommonBehavior(function (e) {
                ...
                }), onClick: handleCommonBehavior(function () {
                    useMentionInputDetection();
                }), onInput: handleCommonBehavior(function () {
                    var _a;
                    onStartTyping();
